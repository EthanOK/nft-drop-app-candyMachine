...
const CandyMachine = ({ walletAddress }) => {
  ...
  const getCollectionPDA = async (candyMachine) => {
    const candyMachineID = new PublicKey(candyMachine);
    return (
      await PublicKey.findProgramAddress(
  ...
  const mintToken = async () => {
    ...
    console.log("mintATA:", userTokenAccountAddress.toString());
    ...
    console.log("userPaying:", walletAddress.publicKey.toString());
    ...
    console.log(candyMachineCreator.toString(), creatorBump);
    ...
    if (collectionPDAAccount && candyMachine.state.retainAuthority) {
      try {
        ...
        if (collectionMint) {
          ...
          console.log("Authority: ", candyMachine.state.authority.toString());
          instructions.push(
